...
export default class Projects extends React.Component {
  ...
  state = {
    markers: [
      ...
      {
        coordinate: {
          latitude: 25.554387279727504,
          longitude: 68.80155748752564,
        },
        title: 'Pakistan',
        description:
          'In addition to seasonal food aid, Mercy-USA, in partnership with The Citizens Foundation is building a secondary school in Sindh province of Pakistan. Nearing completion, the school will serve the education needs of students in 6th grade and above who have no nearby access to school. In addition to classrooms, the school will have a computer lab and two science labs.',
        link: 'https://mercyusa.org/project/india/',
        image: require('../assets/pakistan.png'),
        designation: 'Zakat ul-Fitr/Fitra',
      },
      {
        coordinate: {
  ...
  componentDidMount() {
    this.animation.addListener(({ value }) => {
      ...
      this.regionTimeout = setTimeout(() => {
        if (this.index !== index) {
          this.index = index;
          const lat = this.state.markers[index].coordinate.latitude;
          const lon = this.state.markers[index].coordinate.longitude;
